...
object UnsupportedModifierChecker : ProjectStage() {

    override val checkNormalization = false

    override fun process(projectContext: ProjectContext) {
        projectContext.ktFiles.forEach { it.accept(UnsupportedModifierChecker) }
    }

    object UnsupportedModifierChecker : KtTreeVisitorVoid() {
