...
object CoreVkClass : CoreScope(CorePackage.VK) {
    ...
    val C_Queue = CoreClassDeclaration(parent, "Queue", Core.Kt.C_Any, null)
    val C_AssociativeArray = CoreClassDeclaration(parent, "AssociativeArray", Core.Kt.C_Any, null)
    val C_DynamicArray = CoreClassDeclaration(parent, "DynamicArray", Core.Kt.C_Any, null)
