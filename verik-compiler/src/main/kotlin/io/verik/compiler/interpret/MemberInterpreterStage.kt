...
object MemberInterpreterStage : ProjectStage() {

    override val checkNormalization = true

    override fun process(projectContext: ProjectContext) {
        val memberReplacer = MemberReplacer(projectContext)
        val memberInterpreterVisitor = MemberInterpreterVisitor(memberReplacer)
        projectContext.project.accept(memberInterpreterVisitor)
        memberReplacer.updateReferences()
    }

    class MemberInterpreterVisitor(private val memberReplacer: MemberReplacer) : TreeVisitor() {
