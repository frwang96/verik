...
internal class DeclarationCasterTest : BaseTest() {
    ...
    fun `class with class`() {
        ...
        assertElementEquals(
            "KtBasicClass(C, [], [KtBasicClass(D, [], [], [], false, [])], [], false, [])",
    ...
    fun `class with function`() {
        ...
        assertElementEquals(
            "KtBasicClass(C, [], [KtFunction(f, [], Unit, *, [])], [], false, [])",
            projectContext.findDeclaration("C")
        )
    }
    ...
    fun `class with property`() {
        ...
        assertElementEquals(
            "KtBasicClass(C, [], [KtProperty(x, Boolean, *, [])], [], false, [])",
            projectContext.findDeclaration("C")
        )
    }
    ...
    fun `class with companion object`() {
        ...
        assertElementEquals(
            "KtBasicClass(C, [], [KtBasicClass(Companion, [], [], [], false, [])], [], false, [])",
            projectContext.findDeclaration("C")
        )
    }
    ...
    fun `class with type parameter`() {
        ...
        assertElementEquals(
            "KtBasicClass(C, [TypeParameter(T, Any)], [], [], false, [])",
            projectContext.findDeclaration("C")
        )
    }
    ...
    fun `enum class`() {
        ...
        assertElementEquals(
            "KtBasicClass(E, [], [KtEnumEntry(A, E, [])], [], true, [])",
