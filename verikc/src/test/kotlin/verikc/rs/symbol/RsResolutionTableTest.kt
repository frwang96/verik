...
internal class RsResolutionTableTest {

    @Test
    fun `scope is file`() {
        val resolutionTable = RsResolutionTable()
        resolutionTable.addFile(Symbol(2), listOf(RsResolutionEntry(listOf(Symbol(2)), listOf())))
        assertEquals(
            listOf(RsResolutionEntry(listOf(Symbol(2)), listOf())),
    ...
    fun `scope is declaration`() {
        ...
        assertEquals(
            listOf(
                RsResolutionEntry(listOf(Symbol(3)), listOf()),
                RsResolutionEntry(listOf(Symbol(2)), listOf())
            ),
