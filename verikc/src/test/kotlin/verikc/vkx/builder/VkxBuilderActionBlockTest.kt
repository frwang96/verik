...
import verikc.vkx.ast.VkxExpressionFunction
import verikc.vkx.ast.VkxExpressionLiteral

internal class VkxBuilderActionBlockTest {
    ...
    fun `com action block`() {
        ...
        assertEquals(expected, VkxBuildUtil.buildModuleActionBlock("", string))
    }
    ...
    fun `seq action block no on expression`() {
        ...
        assertThrowsMessage<LineException>("on expression expected for seq block") {
            VkxBuildUtil.buildModuleActionBlock("", string)
        }
    }
