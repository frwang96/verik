...
internal class GexGenerifierExpressionTest {
    ...
    fun `function finish`() {
        ...
        assertEquals(
            ...
            GexGenerifyUtil.generifyExpression("", string).typeGenerified
        )
    }
    ...
    fun `property bool`() {
        ...
        assertEquals(
            ...
            GexGenerifyUtil.generifyExpression(moduleContext, string).typeGenerified
        )
    }
