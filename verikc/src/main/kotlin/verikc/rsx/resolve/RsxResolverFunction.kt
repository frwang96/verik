...
object RsxResolverFunction {
    ...
    fun matches(argsParentTypeSymbols: List<List<Symbol>>, functionEntry: RsxFunctionEntry): Boolean {
    ...
    private fun dominates(
        functionEntry: RsxFunctionEntry,
        functionArgsParentTypeSymbols: List<List<Symbol>>,
        comparisonFunctionEntry: RsxFunctionEntry
    ): Boolean {
