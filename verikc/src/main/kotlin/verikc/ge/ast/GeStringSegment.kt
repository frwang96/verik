...
sealed class GeStringSegment(
    ...
    companion object {
        ...
        operator fun invoke(stringSegment: RsStringSegment): GeStringSegment {
            return when (stringSegment) {
                is RsStringSegmentLiteral -> GeStringSegmentLiteral(stringSegment)
                is RsStringSegmentExpression -> GeStringSegmentExpression(stringSegment)
            }
        }
    }
}
...
data class GeStringSegmentExpression(
    ...
    constructor(stringSegment: RsStringSegmentExpression): this(
        ...
        GeExpression(stringSegment.expression)
    )
}
