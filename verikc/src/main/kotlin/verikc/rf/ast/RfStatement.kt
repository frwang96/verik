    ...
    companion object {
        ...
        operator fun invoke(statement: VkStatement): RfStatement {
            return when (statement) {
                is VkStatementDeclaration -> RfStatementDeclaration(statement)
...
data class RfStatementDeclaration(
    val primaryProperty: RfPrimaryProperty
): RfStatement(primaryProperty.line) {

    constructor(statement: VkStatementDeclaration): this(
        RfPrimaryProperty(statement.primaryProperty)
    )
}
