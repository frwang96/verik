...
data class VkxCompilationUnit(
    val pkgs: List<VkxPkg>
) {

    constructor(compilationUnit: GexCompilationUnit): this(
        compilationUnit.pkgs.map { VkxPkg(it) }
    )

    fun pkg(pkgSymbol: Symbol): VkxPkg {
