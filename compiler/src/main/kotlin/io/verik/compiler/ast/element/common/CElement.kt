...
inline fun <reified T : CElement> CElement.cast(): T? {
    return this.cast(this.location)
}

inline fun <reified T : CElement> CElement?.cast(location: KtElement): T? {
    return this.cast(location.getSourceLocation())
}

inline fun <reified T : CElement> CElement?.cast(location: CElement): T? {
    return this.cast(location.location)
}

inline fun <reified T : CElement> CElement?.cast(location: SourceLocation): T? {
