...
abstract class CAbstractClass : CDeclaration(), DeclarationContainer {

    abstract var supertype: Type
    abstract var typeParameters: ArrayList<CTypeParameter>
    abstract var declarations: ArrayList<CDeclaration>
