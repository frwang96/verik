...
/**
 * Annotates imported declarations that are static in SystemVerilog. It is generated by the importer and should not be
 * used directly.
 */
@Target(AnnotationTarget.CLASS)
annotation class ImportStatic

/**
 * Annotates imported declarations that are parameters in SystemVerilog. It is generated by the importer and should not
 * be used directly.
 */
@Target(AnnotationTarget.VALUE_PARAMETER)
annotation class ImportParam
