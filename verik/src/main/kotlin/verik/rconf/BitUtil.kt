...
internal object BitUtil {

    fun get_hex_string(size: Int, value: String): String {
        return if (size == 0) "0"
        else {
    ...
    private fun get_boolean_array(size: Int, value: String): BooleanArray {
        val x = value.toInt()
    ...
    private fun get_hex_digit(digit: Int): Char {
        return when {
            digit < 10 -> '0' + digit
            digit < 16 -> 'a' + digit - 10
