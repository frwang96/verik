...
def main():
    print()
    print_header("install", "verikx")
    gradle(os.path.join(script_dir, "verikx"), "install")
    print_header("install", "verikxc")
    gradle(os.path.join(script_dir, "verikxc"), "install")

    example_root_dir = os.path.join(script_dir, "examplesx")
    ...
    for example_dir in example_dirs:
        print_header("verikxc", os.path.relpath(example_dir, script_dir))
        gradle(example_dir, "verikxc")
