...
public interface KotlinParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link KotlinParser#comparisonWithLiteralRightSide}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComparisonWithLiteralRightSide(KotlinParser.ComparisonWithLiteralRightSideContext ctx);
	/**
