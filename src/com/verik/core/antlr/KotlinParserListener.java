...
public interface KotlinParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link KotlinParser#comparisonWithLiteralRightSide}.
	 * @param ctx the parse tree
	 */
	void enterComparisonWithLiteralRightSide(KotlinParser.ComparisonWithLiteralRightSideContext ctx);
	/**
	 * Exit a parse tree produced by {@link KotlinParser#comparisonWithLiteralRightSide}.
	 * @param ctx the parse tree
	 */
	void exitComparisonWithLiteralRightSide(KotlinParser.ComparisonWithLiteralRightSideContext ctx);
	/**
