...
class SourceBuilder private constructor(private val labelLineNumbers: Boolean, private val labelLength: Int) {
    ...
    constructor(config: ProjectConfig, source: SourceConfig, labelLength: Int): this(config.labelLines, labelLength) {
        ...
        builder.appendln("""
            ...
            //  File:     ${source.dest.relativeTo(config.projectDir)}
            //  Source:   ${source.source.relativeTo(config.projectDir)}
            ////////////////////////////////////////////////////////////////////////////////
        """.trimIndent())
        builder.appendln()
