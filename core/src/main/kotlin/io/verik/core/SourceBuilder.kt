...
class SourceBuilder private constructor(private val labelLineNumbers: Boolean, private val labelLength: Int) {
    ...
    constructor(config: ProjectConfig, labelLength: Int): this(config.labelLineNumbers, labelLength) {
        ...
        builder.appendln("""
            ...
            //  File:     ${config.destFile.relativeTo(config.projectDir)}
            //  Source:   ${config.sourceFile.relativeTo(config.projectDir)}
            ////////////////////////////////////////////////////////////////////////////////
        """.trimIndent())
        builder.appendln()
