...
data class VkxStringSegmentLiteral(val string: String): VkxStringSegment() {

    companion object {

        operator fun invoke(segment: KtStringSegmentLiteral): VkxStringSegmentLiteral {
            return VkxStringSegmentLiteral(segment.string)
        }
    }
}

data class VkxStringSegmentExpression(val expression: VkxExpression): VkxStringSegment() {

    companion object {

        operator fun invoke(segment: KtStringSegmentExpression): VkxStringSegmentExpression {
            return VkxStringSegmentExpression(VkxExpression(segment.expression))
        }
    }
}
